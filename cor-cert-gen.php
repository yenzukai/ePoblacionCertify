...
<?php
    ...
    // You can customize the certificate template as needed
        ...
        img.signature {
            position: absolute;
            top: 730px; /* Adjust the top position as needed */
        ...
        <p>This is to certify that <strong>$first_name $middle_name $last_name</strong> of legal age, is a resident of </br><strong>Brgy. $barangay $municipality $province $zip_code</strong>.</p>
        <p>Based on the records of this office, he/she has been residing in <strong>$house_no, $street_name</strong>.</p>
        <p>This certification is hereby issued upon the request of the above named person for the sole purporse of compliance.
